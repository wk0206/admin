...
var Card = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var className = props.className,
      ...
      tabs = props.tabs,
      type = props.type,
      rest = _objectWithoutProperties(props, ["className", "style", "bodyStyle", "headStyle", "title", "subTitle", "extra", "tip", "wrap", "layout", "loading", "gutter", "tooltip", "split", "headerBordered", "bordered", "children", "size", "actions", "ghost", "hoverable", "direction", "collapsed", "collapsible", "defaultCollapsed", "onCollapse", "tabs", "type"]);
  ...
  var childrenModified = childrenArray.map(function (element, index) {
    ...
    if (element === null || element === void 0 ? void 0 : (_element$type = element.type) === null || _element$type === void 0 ? void 0 : _element$type.isProCard) {
      ...
      return /*#__PURE__*/React.createElement("div", {
        style: _objectSpread(_objectSpread({}, colSpanStyle), getStyle(normalizedGutter[0] > 0, {
  ...
  var cardBodyStyle = _objectSpread(_objectSpread(_objectSpread({}, getStyle(normalizedGutter[0] > 0, {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    style: style,
    ref: ref
  }, omit(rest, ['id', 'prefixCls', 'colSpan'])), (title || extra || collapsibleButton) && /*#__PURE__*/React.createElement("div", {
