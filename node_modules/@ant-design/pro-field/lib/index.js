...
var defaultRenderText = function defaultRenderText(text, valueType, props, valueTypeMap) {
  ...
  if (valueType === 'color') {
    return /*#__PURE__*/_react.default.createElement(_ColorPicker.default, _extends({
      text: text
    }, props));
  }
...
var ProField = function ProField(_ref, ref) {
  ...
  var text = _ref.text,
      ...
      value = _ref.value,
      rest = _objectWithoutProperties(_ref, ["text", "valueType", "onChange", "renderFormItem", "value"]);
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, defaultRenderText((_ref2 = text !== null && text !== void 0 ? text : fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.value) !== null && _ref2 !== void 0 ? _ref2 : '', valueType || 'text', _objectSpread(_objectSpread({}, rest), {}, {
    ...
    renderFormItem: renderFormItem ? function () {
      ...
      if ( /*#__PURE__*/_react.default.isValidElement(newDom)) return /*#__PURE__*/_react.default.cloneElement(newDom, _objectSpread(_objectSpread({
