...
var FieldPassword = function FieldPassword(_ref, ref) {
  var text = _ref.text,
      ...
      rest = _objectWithoutProperties(_ref, ["text", "mode", "render", "renderFormItem", "fieldProps", "proFieldKey"]);
  ...
  if (mode === 'edit' || mode === 'update') {
    var _dom = /*#__PURE__*/_react.default.createElement(_antd.Input.Password, _extends({
