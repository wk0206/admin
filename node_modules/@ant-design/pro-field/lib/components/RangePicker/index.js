...
var FieldRangePicker = function FieldRangePicker(_ref, ref) {
  ...
  var parsedStartText = startText ? (0, _moment.default)(startText).format(format || fieldProps.format || 'YYYY-MM-DD') : '';
  var parsedEndText = endText ? (0, _moment.default)(endText).format(format || fieldProps.format || 'YYYY-MM-DD') : '';
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    var _dom = /*#__PURE__*/_react.default.createElement(_antd.DatePicker.RangePicker, _extends({
      ref: ref,
      format: format,
      showTime: showTime,
