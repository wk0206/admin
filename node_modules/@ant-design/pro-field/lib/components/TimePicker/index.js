...
var FieldTimePicker = function FieldTimePicker(_ref, ref) {
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    if (light) {
      ...
      }, /*#__PURE__*/_react.default.createElement(_antd.TimePicker, _extends({
        value: momentValue,
        format: format,
        ref: ref
      }, fieldProps, {
      ...
      _dom = /*#__PURE__*/_react.default.createElement(_antd.DatePicker.TimePicker, _extends({
        ref: ref,
        format: format,
...
var FieldTimeRangePicker = function FieldTimeRangePicker(_ref2) {
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    var _dom2 = /*#__PURE__*/_react.default.createElement(_antd.TimePicker.RangePicker, _extends({
      format: format,
      bordered: plain === undefined ? true : !plain
    }, fieldProps, {
      value: momentValue
