...
var SearchSelect = function SearchSelect(props, ref) {
  var optionItemRender = props.optionItemRender,
      ...
      restProps = _objectWithoutProperties(props, ["optionItemRender", "mode", "onSearch", "onFocus", "onChange", "searchOnFocus", "resetAfterSelect", "optionFilterProp", "optionLabelProp", "className", "disabled", "options", "fetchData", "resetData", "prefixCls", "onClear", "searchValue"]);
    ...
    return mapOptions.map(function (item) {
      ...
      if (optionType === 'optGroup') {
        return /*#__PURE__*/React.createElement(OptGroup, {
          ...
          label: item.label
        }, renderOptions((item === null || item === void 0 ? void 0 : item.children) || []));
      }
