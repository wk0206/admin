...
var FieldRangePicker = function FieldRangePicker(_ref, ref) {
  ...
  var parsedStartText = startText ? moment(startText).format(format || fieldProps.format || 'YYYY-MM-DD') : '';
  var parsedEndText = endText ? moment(endText).format(format || fieldProps.format || 'YYYY-MM-DD') : '';
