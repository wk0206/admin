...
function BaseForm(props) {
  var children = props.children,
      ...
      rest = _objectWithoutProperties(props, ["children", "contentRender", "submitter", "fieldProps", "formItemProps", "groupProps", "dateFormatter", "form", "formRef", "onInit", "extraUrlParams", "syncToUrl", "syncToInitialValues", "onReset", "omitNil"]);
  ...
  var submitterNode = submitter === false ? undefined : /*#__PURE__*/_react.default.createElement(_Submitter.default, _extends({
    ...
    onReset: function onReset() {
      ...
      if (syncToUrl) {
        ...
        var params = Object.keys(transformKey(formRef.current.getFieldsValue(), false)).reduce(function (pre, next) {
  ...
  (0, _react.useEffect)(function () {
    var finalValues = transformKey(formRef.current.getFieldsValue(true), omitNil);
    onInit === null || onInit === void 0 ? void 0 : onInit(finalValues); // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []); // 如果为 false，不需要触发设置进去
