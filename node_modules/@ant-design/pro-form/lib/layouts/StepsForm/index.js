...
function StepsForm(props) {
  ...
  var current = props.current,
      ...
      rest = _objectWithoutProperties(props, ["current", "onCurrentChange", "submitter", "stepsFormRender", "stepsRender", "stepFormRender", "stepsProps", "onFinish", "formProps", "containerStyle", "formRef", "formMapRef"]);
  ...
  }, /*#__PURE__*/_react.default.createElement(_antd.Steps, _extends({}, stepsProps, {
    current: step,
    onChange: undefined
  ...
  var next = submitter !== false && /*#__PURE__*/_react.default.createElement(_antd.Button, _extends({
    key: "next",
    type: "primary",
    loading: loading
  ...
  var pre = submitter !== false && /*#__PURE__*/_react.default.createElement(_antd.Button, _extends({
    key: "pre"
  ...
  var submit = submitter !== false && /*#__PURE__*/_react.default.createElement(_antd.Button, _extends({
    key: "submit",
    type: "primary",
    loading: loading
  }, submitter === null || submitter === void 0 ? void 0 : submitter.submitButtonProps, {
...
StepsForm.useForm = _antd.Form.useForm;
