...
var ProFormDependency = function ProFormDependency(_ref) {
  ...
  var getNamePath = (0, _react.useCallback)(function (itemName) {
    ...
    return [formListField.listName, itemName].flat(2);
  ...
  return /*#__PURE__*/_react.default.createElement(_antd.Form.Item, _extends({}, rest, {
    ...
    var values = names.reduce(function (pre, next) {
      ...
      var value = context === null || context === void 0 ? void 0 : (_context$getFieldsFor = context.getFieldsFormatValue) === null || _context$getFieldsFor === void 0 ? void 0 : _context$getFieldsFor.call(context, [next].flat(1));
      var noFormatValue = form.getFieldsValue([next].flat(1));
      return _objectSpread(_objectSpread(_objectSpread({}, pre), noFormatValue), value);
    }, {});
    ...
    return children === null || children === void 0 ? void 0 : children(_objectSpread(_objectSpread({}, values), nameValues), form);
  });
};
