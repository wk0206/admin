...
function BetaSchemaForm(props) {
  ...
  var _ProForm$useForm = _index.default.useForm(),
  ...
  var genItems = (0, _react.useCallback)(function (items, update) {
    return items.sort(function (a, b) {
      ...
      var title = (0, _proUtils.runFunction)(originItem.title, 'form');
      var item = (0, _proUtils.omitUndefined)({
        name: originItem.name,
        valueType: (0, _proUtils.runFunction)(originItem.valueType, {}),
        key: originItem.key,
        columns: originItem.columns,
        fieldProps: (0, _proUtils.runFunction)(originItem.fieldProps, formRef.current, originItem),
        valueEnum: originItem.valueEnum,
        dataIndex: originItem.key || originItem.dataIndex,
        initialValue: originItem.initialValue,
        formItemProps: (0, _proUtils.runFunction)(originItem.formItemProps, formRef.current, originItem),
      ...
      if (item.valueType === 'group') {
        ...
        return /*#__PURE__*/_react.default.createElement(_index.ProFormGroup, _extends({
          key: key,
          label: item.title
      ...
      if (item.valueType === 'formSet' && item.dataIndex) {
        if (!item.columns) return null;
        return /*#__PURE__*/_react.default.createElement(_index.ProFormFieldSet, _extends({}, item.formItemProps, {
          key: key,
          initialValue: item.initialValue,
          name: item.dataIndex,
          label: item.title
      ...
      var defaultRender = function defaultRender() {
        return /*#__PURE__*/_react.default.createElement(_index.ProFormField, _extends({}, formFieldProps, {
          ignoreFormItem: true
        }));
      };
  ...
  var domList = (0, _react.useMemo)(function () {
