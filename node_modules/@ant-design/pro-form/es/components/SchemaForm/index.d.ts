...
/** ProForm 的特色 layout */
export declare type ProFormLayoutType = 'Form' | 'ModalForm' | 'DrawerForm' | 'StepsForm' | 'StepForm' | 'LightFilter' | 'QueryFilter';
/** ProForm 支持的相关类型 */
export declare type ProFormPropsType<T> = Omit<DrawerFormProps<T>, 'onFinish'> & Omit<QueryFilterProps<T>, 'onFinish'> & ProFormProps<T> & Omit<StepFormProps<T>, 'onFinish'> & {
    layoutType?: ProFormLayoutType;
};
export declare type FormFieldType = 'group' | 'formList' | 'formSet';
