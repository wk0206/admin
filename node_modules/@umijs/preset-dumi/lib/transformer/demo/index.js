...
var _default = (raw, opts) => {
  ...
  if ((0, _utils2.isDynamicEnable)()) {
    ...
    demoFunction = types().callExpression(types().identifier('dynamic'), [types().objectExpression([types().objectProperty(types().identifier('loader'), types().functionExpression(null, [], types().blockStatement(body), false, true))])]);
  } else {
