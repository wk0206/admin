...
var _default = (routes, opts, umi) => {
  ...
  decorator.use(_flat.default).use(_frontMatter.default).use(_hide.default).use(_locale.default).use(_title.default).use(_nav.default).use(_group.default).use(_fallback.default).use(_integrate.default).use(_redirect.default).use(_relative.default);
