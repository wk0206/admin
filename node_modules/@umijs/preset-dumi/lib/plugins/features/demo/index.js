...
var _default = api => {
  ...
  api.modifyRoutes( /*#__PURE__*/function () {
    ...
    `;
      const demoRouteComponent = (0, _utils2.isDynamicEnable)() ? `React.createElement(
        dynamic({
          loader: async () => {
      ...
      prependRoutes[0].wrappers = [// builtin outer layout, for initialize context
      api.utils.winPath(_path().default.join(__dirname, '../../../theme/layout')), theme.layoutPaths.demo].filter(Boolean);
